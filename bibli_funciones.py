...
def Aplicativo(app, url, ejecucion_demanda_parte_2, dem_total):   
    ...
    @app.callback(
        ...
        Output("resultado-carga", "children"),
    ...
    def cargar(n_clicks, ruta):
        ...
        if button_id == 'execute-button-cargar':
          ...
          time.sleep(1)
          return None, 'Cargado Exitosamente'
    ...
    def cambiar_indice_1(n_clicks_continuar, n_clicks_retroceder, data, current_index, valor):
        if data is not None:
            current_index = next((i for i, option in enumerate(data['option_usuario_3_a']) if data['option_usuario_3_a']['value'] == valor), None)
